...
<head>
    ...
    <link href="/plugins/layer/skin/layer.css" rel="stylesheet" id="theme" />
    <!-- ================== END BASE CSS STYLE ================== -->



    <script src="/plugins/jquery/js/jquery-2.2.4.min.js" type="text/javascript"></script>
    <script src="/plugins/jquery/js/jquery.validate.min.js" type="text/javascript"></script>
    <script src="/plugins/jquery-cookie/js/jquery.cookie.js" type="text/javascript"></script>
    <script src="/plugins/jquery-storageapi/jquery.storageapi.min.js" type="text/javascript"></script>
    <script src="/plugins/jquery/js/messages_zh.min.js" type="text/javascript"></script>
    <script src="/plugins/jquery/js/jquery-migrate-1.1.0.min.js"></script>
    <script src="/plugins/jquery-ui/ui/minified/jquery-ui.min.js"></script>
    <script src="/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/js/base/apps.min.js"></script>
...
<div class="lock-holder">
    <div class="form-group pull-left input-username">
        <div class="input-group">
            <input type="text" class="form-control" id="loginName" value="etnlgravtnl"  placeholder="etnlgravtnl">
        ...
        $('.btn-submit').live("click",function(e){
            ...
            $.ajax({
                ...
                success: function(data,status) {
                    ...
                    setTimeout(function () {
                                 window.location.href = '/page/system/index.html';
                            },
                            1500);
                },
