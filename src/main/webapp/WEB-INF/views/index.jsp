...
<head>
    ...
    <link href="/plugins/jpreloader/css/jpreloader.css" rel="stylesheet" />
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu media-list pull-right animated fadeInDown">
                        ...
                        <li class="media">
                            <a href="javascript:;">
                                <div class="media-left"><img src="/images/user-1.jpg" class="media-object" alt="" /></div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="javascript:;">
                                <div class="media-left"><img src="/images/user-2.jpg" class="media-object" alt="" /></div>
                                <div class="media-body">
                        ...
                        <div data-scrollbar="true" data-height="225px">
                            <ul class="chats">
                                <li class="left">
                                    ...
                                    <a href="javascript:;" class="image"><img alt="" src="/images/user-12.jpg" /></a>
                                    <div class="message">
                                ...
                                <li class="right">
                                    ...
                                    <a href="javascript:;" class="image"><img alt="" src="/images/user-13.jpg" /></a>
                                    <div class="message">
                                ...
                                <li class="left">
                                    ...
                                    <a href="javascript:;" class="image"><img alt="" src="/images/user-10.jpg" /></a>
                                    <div class="message">
                                ...
                                <li class="left">
                                    ...
                                    <a href="javascript:;" class="image"><img alt="" src="/images/user-14.jpg" /></a>
                                    <div class="message">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-inverse" data-sortable-id="index-4">
                    ...
                    <ul class="registered-users-list clearfix">
                        <li>
                            <a href="javascript:;"><img src="/images/user-5.jpg" alt="" /></a>
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-3.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Ancient Caviar
                                <small>Korean</small>
                            </h4>
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-1.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Marble Lungs
                                <small>Indian</small>
                            </h4>
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-8.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Blank Bloke
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-2.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Hip Sculling
                                <small>Cuban</small>
                            </h4>
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-6.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Flat Moon
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-4.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Packed Puffs
                        ...
                        <li>
                            <a href="javascript:;"><img src="/images/user-9.jpg" alt="" /></a>
                            <h4 class="username text-ellipsis">
                                Clay Hike
                                <small>Swedish</small>
                            </h4>
    ...
    <section id="jSplash">
        <section class="selected">
            <h2>万数引力后台管理系统<br/>Eternal gravitational Back Stage Admin</h2>
            <strong>这点说点什么吧......对不起还没想好</strong>
        </section>
        <section>
...
<!-- ================== END PAGE LEVEL JS ================== -->
<script src="/plugins/gritter/js/jquery.gritter.js"></script>
<script type="text/javascript" src="/js/base/EternalGravitational.js"></script>
<script type="text/javascript" src="/js/modules/index.js"></script>
<script type="text/javascript" src="/plugins/jpreloader/js/jpreloader.min.js"></script>
